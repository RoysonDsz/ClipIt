  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || "Failed to download reel.");
      }
    } catch (err) {
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white p-6">
      ...
      <div className="w-full max-w-md">
        ...
        <button
          ...
          className="w-full mt-4 bg-pink-500 hover:bg-pink-600 p-3 rounded-lg font-bold"
          disabled={loading}
        >
      ...
      {loading && <div className="mt-4 animate-spin rounded-full h-8 w-8 border-t-4 border-pink-500"></div>}
